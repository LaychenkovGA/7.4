...
describe("Task two, add three tests", () => {
  ...
  test("Enter email to field sing up with github", async () => {
    ...
    await page.locator(".form-control.f4-mktg.width-full.rounded-md-right-0").fill("cracers2no95@mail.com");
    await page.locator(".btn-mktg.width-full.width-md-auto.mb-3.mb-md-0.rounded-md-left-0.home-campaign-signup-button.btn-signup-mktg").click();
  }, 99999);
});